...
if ( class_exists( 'BizCity_Probe_Scheduler_Target_V2', false ) ) {
	return;
}

final class BizCity_Probe_Scheduler_Target_V2 implements BizCity_Diagnostics_Probe {
	...
	public function precondition() {
		return class_exists( 'BizCity_Scheduler_Notify_Target_Resolver' )
			? true
			: new WP_Error( 'class_missing', 'BizCity_Scheduler_Notify_Target_Resolver chưa load.' );
	}
...
add_filter( 'bizcity_diagnostics_register_probes', function ( $list ) {
	$list[] = 'BizCity_Probe_Scheduler_Target_V2';
	return $list;
} );
