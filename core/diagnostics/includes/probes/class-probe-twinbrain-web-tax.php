...
final class BizCity_Probe_TwinBrain_Web_Tax implements BizCity_Diagnostics_Probe {
	...
	public function precondition() {
		...
		// [2026-08-21 Johnny Chu] R-DDV-MOCK-GATEWAY — tax vertical is a live Search + LLM contract.
		if ( defined( 'BIZCITY_DIAGNOSTICS_MOCK' ) && BIZCITY_DIAGNOSTICS_MOCK ) return 'Mock mode: bỏ qua Web Tax live gateway probe.';
		return true;
	}
